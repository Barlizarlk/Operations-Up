...
class Paths
{
	...
	inline static public function voiceOpponent(song:String):Any
	{
		#if html5
		return 'songs:assets/songs/${formatToSongPath(song)}/VoiceOpponent.$SOUND_EXT';
		#else
		var songKey:String = '${formatToSongPath(song)}/VoiceOpponent';
		var voiceOpponent = returnSound('songs', songKey);
		return voiceOpponent;
		#end
	}

	inline static public function voiceBf(song:String):Any
	{
		#if html5
		return 'songs:assets/songs/${formatToSongPath(song)}/VoiceBf.$SOUND_EXT';
		#else
		var songKey:String = '${formatToSongPath(song)}/VoiceBf';
		var voiceBf = returnSound('songs', songKey);
		return voiceBf;
		#end
	}
