...
class VisualsUISubState extends BaseOptionsMenu
{
	...
	public function new()
	{
		...
		var option:Option = new Option('Psych HUD',
			'If checked, brings back the psych UI',
			'psychHud',
			'bool');
		addOption(option);
		...
		var option:Option = new Option('Wiggly Note Sustains',
			"If unchecked, The sustains on notes will not bop to the beat.",
			'wavySustains',
			'bool');
		addOption(option);
