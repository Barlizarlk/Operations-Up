...
{
    var Practice:Bool; // done

    var SingleDigits:Bool; // done

    var Perfect:Bool; // done

    var ShittyEnding:Bool; // done

    var BadTrip:Bool; // done

    var TruePerfect:Bool; // done

    var LivesSwitch:Bool; // done
    var Lives:Float; // done

    var BrightnessSwitch:Bool; // done
    var Brightness:Float; // done

    var HPGainSwitch:Bool; // done
    var HPGain:Float; // done

    var HPLossSwitch:Bool; // done
    var HPLoss:Float; // done

    var StartHealthSwitch:Bool; // done
    var StartHealth:Float; // done

    var Enigma:Bool; // done

    var VibeSwitch:Bool; // will not do
    var Vibe:Float; // will not do

    var OffbeatSwitch:Bool; // will not do
    var Offbeat:Float; // will not do

    var HitZonesSwitch:Bool; // already done in base game
    var HitZones:Float; // already done in base game

    var NoteSpeedSwitch:Bool; // already done in base game
    var NoteSpeed:Float; // already done in base game

    var InvisibleNotes:Bool; // done

    var SnakeNotesSwitch:Bool; // done
    var SnakeNotes:Float; // done

    var DrunkNotesSwitch:Bool; // done
    var DrunkNotes:Float; // done

    var AccelNotesSwitch:Bool; // will not do
    var AccelNotes:Float; // will not do

    var ShortsightedSwitch:Bool; // will not do
    var Shortsighted:Float; // will not do

    var LongsightedSwitch:Bool; // will not do
    var Longsighted:Float; // will not do

    var FlippedNotes:Bool; // will not do

    var HyperNotesSwitch:Bool; // done
    var HyperNotes:Float; // done

    var EelNotesSwitch:Bool; // will not do
    var EelNotes:Float; // will not do

    var StretchSwitch:Bool; // done
    var Stretch:Float; // done

    var WidenSwitch:Bool; // done
    var Widen:Float; // done

    var SeasickSwitch:Bool; // done
    var Seasick:Float; // done

    var UpsideDown:Bool; // done

    var Mirror:Bool; // done

    var CameraSwitch:Bool; // done
    var Camera:Float; // done

    var EarthquakeSwitch:Bool; // done
    var Earthquake:Float; // done

    var LoveSwitch:Bool; // done
    var Love:Float; // done

    var FrightSwitch:Bool; // done
    var Fright:Float; // done

    var MustDieSwitch:Bool; // done
    var MustDie:Float; // done

    var FreezeSwitch:Bool; // will not do
    var Freeze:Float; // will not do

    var PaparazziSwitch:Bool; // will not do
    var Paparazzi:Float; // will not do

    var JacktasticSwitch:Bool; // will not do
    var Jacktastic:Float; // will not do
}
